    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Details(string id)
        {
            ...
            var category = await _context.category
                .FirstOrDefaultAsync(m => m.category_name == id);
            if (category == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("id,category_name")] category category)
        {
        ...
        {
          return (_context.category?.Any(e => e.category_name == id)).GetValueOrDefault();
        }
    }
}
